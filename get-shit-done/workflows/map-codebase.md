...
```bash
INIT=$(node C:/Users/li182/.claude/get-shit-done/bin/gsd-tools.cjs init map-codebase)
```
...
```bash
node C:/Users/li182/.claude/get-shit-done/bin/gsd-tools.cjs commit "docs: map existing codebase" --files .planning/codebase/*.md
```
