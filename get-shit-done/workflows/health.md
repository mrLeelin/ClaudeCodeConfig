...
```bash
node C:/Users/li182/.claude/get-shit-done/bin/gsd-tools.cjs validate health $REPAIR_FLAG
```
...
```bash
node C:/Users/li182/.claude/get-shit-done/bin/gsd-tools.cjs validate health
```
