...
```bash
TRANSITION=$(node C:/Users/li182/.claude/get-shit-done/bin/gsd-tools.cjs phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node C:/Users/li182/.claude/get-shit-done/bin/gsd-tools.cjs progress bar --raw)
```
...
```bash
node C:/Users/li182/.claude/get-shit-done/bin/gsd-tools.cjs config-set workflow.auto_advance false
```
